...
namespace sc.apps.lib.mcf.Const
{
    ...
    {
        public const string REFERENCE_INVOICE_NULL = "Une erreur s'est produite, la référence de la facture de remoursement est obligatoire";
        ...
        public const string ARGUMENT_NULL_EXCEPTION = "Une erreur s'est produite, une ou plusieurs paramètres sont null, cause probable:";
        public const string INVALID_OPERATION_EXCEPTION = "Une erreur s'est produite, l'opération demandé n'est pas disponible, cause probable:";
        ...
        public const string TIME_OUT_EXCEPTION = "Une erreur s'est produite, le temps de répose du MCF est dépassé, cause probable:";
        public const string DECODER_FALL_BACK_EXCEPTION = "Une erreur s'est produite, la conversion de la reponse à échouée ,cause probable:";
